...
begin
	...
	md"Profile vocabulary in analyzed edition: notebook version **0.2.0**"
end
...
# ╔═╡ c70f8184-09d1-4e03-8402-12ee9a7df794
md"Top **$(vocabsize)** lexemes:"
...
# ╔═╡ 3bca1de9-37c1-4d55-a850-62c1fcc737c5
begin
	vocablist = []
	for i in 1:vocabsize
		push!(vocablist, string(i, ". ", lexcounts[i][1], " (**", lexcounts[i][2], "** tokens)"))
	end
	Markdown.parse("""$(join(vocablist,"\n"))
	""")
end
...
| Morphological ambiguity (analyses/ tokens analyzed) | **$(round(numtokenanalyses * 1.0 /  numanalyzedtokens, digits=2))** |
