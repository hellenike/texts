...
analyses = fromcex.(analyzedtokens[:,:analysiscex])

# ╔═╡ 5eb787e6-5fd9-11eb-3fc3-81912954efb6
numlexemes = (map(a -> a.lexeme, analyses) |> length)


# ╔═╡ 07faa161-33af-4ae6-bdb9-d5df3b99bb2a
ismissing(numlexemes) ? missing : md"*Choose number of lexemes*: $(@bind vocabsize Slider(1:numlexemes, show_value=true, default=10))"
...
numpossiblelexemes = ismissing(lexemesByToken) ? missing :  nrow(lexemesByToken)
...
| Distinct tokens | **$(numanalyzedforms)** |
